...
local ClosureBindings = {
    ...
    return {
        Name = "InfernoX Hub Neon",
        Accent = Color3.fromRGB(255, 60, 60), -- แดงเรืองแสง

        AcrylicMain = Color3.fromRGB(15, 15, 15),
        AcrylicBorder = Color3.fromRGB(30, 0, 0),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 0, 0), Color3.fromRGB(10, 10, 10)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(60, 0, 0),
        Tab = Color3.fromRGB(255, 30, 30),

        Element = Color3.fromRGB(25, 25, 25),
        ElementBorder = Color3.fromRGB(60, 0, 0),
        InElementBorder = Color3.fromRGB(35, 0, 0),
        ElementTransparency = 0.82,

        ToggleSlider = Color3.fromRGB(255, 90, 90),
        ToggleToggled = Color3.fromRGB(40, 10, 10),

        SliderRail = Color3.fromRGB(255, 40, 70),

        DropdownFrame = Color3.fromRGB(30, 30, 30),
        DropdownHolder = Color3.fromRGB(15, 15, 15),
        DropdownBorder = Color3.fromRGB(60, 0, 0),
        DropdownOption = Color3.fromRGB(40, 0, 0),

        Keybind = Color3.fromRGB(20, 20, 20),

        Input = Color3.fromRGB(15, 15, 15),
        InputFocused = Color3.fromRGB(30, 0, 0),
        InputIndicator = Color3.fromRGB(60, 0, 0),

        Dialog = Color3.fromRGB(20, 20, 20),
        DialogHolder = Color3.fromRGB(25, 5, 5),
        DialogHolderLine = Color3.fromRGB(35, 0, 0),
        DialogButton = Color3.fromRGB(45, 10, 10),
        DialogButtonBorder = Color3.fromRGB(60, 0, 0),
        DialogBorder = Color3.fromRGB(255, 60, 60),
        DialogInput = Color3.fromRGB(25, 10, 10),
        DialogInputLine = Color3.fromRGB(60, 0, 0),
